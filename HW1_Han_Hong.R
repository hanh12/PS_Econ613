...
#q1
av_ad1=colMeans(ad_q1, na.rm = TRUE) 
av_ad1
sd_ad1_quality=sd(ad_q1[,1],na.rm = TRUE) 
sd_ad1_quality
sd_ad1_cutoff=sd(ad_q1[,2],na.rm = TRUE) 
sd_ad1_cutoff
sd_ad1_distance=sd(ad_q1[,3],na.rm = TRUE)
sd_ad1_distance
#q2
av_ad2=colMeans(ad_q2, na.rm = TRUE) 
av_ad2
sd_ad2_quality=sd(ad_q2[,1],na.rm = TRUE) 
sd_ad2_quality
sd_ad2_cutoff=sd(ad_q2[,2],na.rm = TRUE) 
sd_ad2_cutoff
sd_ad2_distance=sd(ad_q2[,3],na.rm = TRUE) 
sd_ad2_distance
#q3
av_ad3=colMeans(ad_q3, na.rm = TRUE) 
av_ad3
sd_ad3_quality=sd(ad_q3[,1],na.rm = TRUE) 
sd_ad3_quality
sd_ad3_cutoff=sd(ad_q3[,2],na.rm = TRUE) 
sd_ad3_cutoff
sd_ad3_distance=sd(ad_q3[,3],na.rm = TRUE)
sd_ad3_distance
#q4
av_ad4=colMeans(ad_q4, na.rm = TRUE) 
av_ad4
sd_ad4_quality=sd(ad_q4[,1],na.rm = TRUE) 
sd_ad4_quality
sd_ad4_cutoff=sd(ad_q4[,2],na.rm = TRUE) 
sd_ad4_cutoff
sd_ad4_distance=sd(ad_q4[,3],na.rm = TRUE) 
sd_ad4_distance
